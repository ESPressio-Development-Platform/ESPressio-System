...
public:
    ...
    virtual std::unique_ptr<IHighResolutionCounter> Create(
...
inline void SetHighResolutionCounterProvider(
    IHighResolutionCounterProvider* provider
) noexcept {
...
inline std::unique_ptr<IHighResolutionCounter> CreateHighResolutionCounter(
    uint64_t requestedResolutionHz
) {
